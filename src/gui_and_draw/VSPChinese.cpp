...
// Geometry names embedded in the bundled complete-aircraft examples.  These
// translations are display-only: the original names remain in the VSP3 model
// so scripts, analysis references, and user data are never rewritten.
const std::unordered_map<std::string, std::string> &BundledAircraftNameTranslations()
{
    static const std::unordered_map<std::string, std::string> table = {
        { "AftCorotating1", "后部同向旋转组件 1" },
        { "AftCorotating2", "后部同向旋转组件 2" },
        { "Alt_CG", "备用重心" },
        { "BoomBattery", "机臂电池" },
        { "Canopy Glass", "座舱盖玻璃" },
        { "CG", "重心" },
        ...
        { "Cockpit", "驾驶舱" },
        { "CruiseNacelle", "巡航短舱" },
        { "CruiseProp-Disk", "巡航螺旋桨桨盘" },
        { "CrzProp", "巡航螺旋桨" },
        { "ElectricActuator", "电动作动器" },
        { "ElectricMotor", "电动机" },
        { "engine1", "发动机 1" },
        { "EngineGroup_1", "发动机组 1" },
        { "EngineGroup_2", "发动机组 2" },
        { "EngineGroup_3", "发动机组 3" },
        { "EngineGroup_4", "发动机组 4" },
        { "EngineGroup_5", "发动机组 5" },
        { "EngineGroup_6", "发动机组 6" },
        { "EngineGroup_7", "发动机组 7" },
        { "EngineGroup_8", "发动机组 8" },
        { "EngineGroup_9_PWPT61200hp", "发动机组 9（PWPT61200hp）" },
        { "EngineGroup_10_generator", "发动机组 10（发电机）" },
        { "Engines", "发动机组" },
        { "engine-tail", "尾部发动机" },
        { "engine-wingtip", "翼尖发动机" },
        { "Flap_Cover_7", "襟翼盖板 7" },
        { "Flap_Cover_9", "襟翼盖板 9" },
        { "Flap_Cover_11", "襟翼盖板 11" },
        { "Flap_Hinge", "襟翼铰链" },
        { "FloorBattery", "地板电池" },
        { "FuelTank_1", "燃油箱 1" },
        { "FuelTank_2_full", "满载燃油箱 2" },
        { "GearPod", "起落架整流舱" },
        { "H Stabs", "水平安定面" },
        { "HL-Disk", "高升力桨盘" },
        { "HLNac-7", "高升力短舱 7" },
        ...
        { "HLNac-12", "高升力短舱 12" },
        { "HorzStab", "水平安定面" },
        { "HorzStab-Hinge", "水平安定面铰链" },
        { "Hub", "桨毂" },
        { "InnerLiftNacelles", "内侧升力短舱" },
        { "Intakes", "进气口" },
        { "LandingGear_005.fronttire", "起落架 005：前轮胎" },
        { "LandingGear_010.maintires", "起落架 010：主轮胎" },
        { "LandingGear_015.NoseStrutFairing", "起落架 015：前起落架支柱整流罩" },
        { "LandingGear_070.MainGearFairing", "起落架 070：主起落架整流罩" },
        { "LEX", "前缘边条" },
        { "LG_leg", "起落架支柱" },
        { "LG_wheel", "起落架机轮" },
        { "LiftProp", "升力螺旋桨" },
        ...
        { "NoseLG", "前起落架" },
        { "OLDOrigin", "旧原点" },
        { "Optimum_Hovering_Rotor_Nb_5", "最优悬停旋翼（叶片数 5）" },
        { "Origin", "原点" },
        { "OuterLiftNacelles", "外侧升力短舱" },
        { "Pant", "机轮整流罩" },
        { "Pod_canard", "鸭翼短舱" },
        { "Pod1", "短舱 1" },
        { "Pod2", "短舱 2" },
        ...
        { "Ref_Geometry", "参考几何体" },
        { "Rotor_1_hub", "旋翼 1 桨毂" },
        { "Rotor_1_support", "旋翼 1 支架" },
        { "Rotor_2_hub", "旋翼 2 桨毂" },
        { "Rotor_2_support", "旋翼 2 支架" },
        { "Rotor_3_hub", "旋翼 3 桨毂" },
        { "Rotor_3_support", "旋翼 3 支架" },
        { "Rotor_4_hub", "旋翼 4 桨毂" },
        { "Rotor_4_support", "旋翼 4 支架" },
        { "Rotor_5_hub", "旋翼 5 桨毂" },
        { "Rotor_5_support", "旋翼 5 支架" },
        { "Rotor_6_hub", "旋翼 6 桨毂" },
        { "Rotor_6_support", "旋翼 6 支架" },
        { "Rotor_7_hub", "旋翼 7 桨毂" },
        { "Rotor_7_hub_rot", "旋翼 7 旋转桨毂" },
        { "Rotor_7_pivot", "旋翼 7 枢轴" },
        { "Rotor_7_support", "旋翼 7 支架" },
        { "Rotor_8_hub", "旋翼 8 桨毂" },
        { "Rotor_8_hub_rot", "旋翼 8 旋转桨毂" },
        { "Rotor_8_pivot", "旋翼 8 枢轴" },
        { "Rotor_8_support", "旋翼 8 支架" },
        { "Strut", "支柱" },
        { "Struts", "支柱组" },
        { "Systems_030.ECS", "系统 030：环境控制系统" },
        { "Systems_030.furnishings", "系统 030：内饰" },
        { "Systems_040.everythingelse", "系统 040：其他设备" },
        { "Tail", "尾翼" },
        { "Tail_1", "尾翼 1" },
        { "Tip Pylons", "翼尖挂架" },
        { "V Stabs", "垂直安定面" },
        ...
        { "wheel_center", "机轮中心" },
        { "Wing_1", "机翼 1" },
        { "Wing_1_AeroCenter", "机翼 1 气动中心" },
        { "Wing_1_pivot", "机翼 1 枢轴" },
        { "Wing_2", "机翼 2" },
        { "Wing_Body", "翼身" },
        { "Wing_Canard", "鸭翼" },
        { "Wing_Horiz", "水平翼" },
        { "Wing_Parent", "母机翼" },
        { "Wing_Vert", "垂直翼" },
        { "WingBatteryInbd", "机翼内侧电池" },
        { "WingBatteryRoot", "翼根电池" },
        { "WingQuarterChord", "机翼四分之一弦线" }
    };
    return table;
}
...
std::string VSPTranslate( const std::string &text )
{
    ...
    const auto &bundled_aircraft_names = BundledAircraftNameTranslations();
    auto bundled_name_iter = bundled_aircraft_names.find( text );
    if ( bundled_name_iter != bundled_aircraft_names.end() )
    {
        return bundled_name_iter->second;
    }
