...
VspButton* GroupLayout::AddParmButton( const char* label )
{
    ...
    button->copy_label( VSPTranslate( label ).c_str() );
...
void GroupLayout::AddButton( CheckButton& cbutton, const char* label, int used_w )
{
    ...
    flbutton->copy_label( VSPTranslate( label ).c_str() );
...
Fl_Box* GroupLayout::AddDividerBox( const string& text, int used_w )
{
    ...
    flbox->copy_label( VSPTranslate( text ).c_str() );
    m_Group->add( flbox );
...
void GroupLayout::AddLegendEntry( const string& text, Fl_Color c )
{
    ...
    button->copy_label( VSPTranslate( text ).c_str() );
    button->box( FL_THIN_UP_BOX );
    button->labelfont( FL_HELVETICA_BOLD );
    button->labelsize( 12 );
    button->labelcolor( FL_BLACK );
...
Vsp_Canvas* GroupLayout::AddCanvas( int w, int h, double xmin, double xmax, double ymin, double ymax, const char *label, const char *xlabel, const char *ylabel )
{
    ...
    Vsp_Canvas* canvas = new Vsp_Canvas( m_X + wyaxis, m_Y, w - wyaxis, h - hxaxis, nullptr );
    canvas->copy_label( VSPTranslate( label ).c_str() );
    ...
    Ca_X_Axis* xaxis = new Ca_X_Axis( m_X, m_Y + h - hxaxis, w + margin, hxaxis, nullptr );
    xaxis->copy_label( VSPTranslate( xlabel ).c_str() );
    ...
    Ca_Y_Axis* yaxis = new Ca_Y_Axis( m_X, m_Y - margin, wyaxis, h + margin, nullptr );
    yaxis->copy_label( VSPTranslate( ylabel ).c_str() );
    ...
    Ca_Y_Axis* y2axis = new Ca_Y_Axis( m_X + w - wyaxis, m_Y - margin, wyaxis, h + margin, nullptr );
    y2axis->copy_label( VSPTranslate( ylabel ).c_str() );
    y2axis->labelsize( 14 );
...
void GroupLayout::AddColorPicker( ColorPicker& picker )
{
    ...
    //==== Button ====//
    Fl_Button* colorButton = new Fl_Button( m_X, m_Y, m_ButtonWidth, m_StdHeight * 2, "颜色：" );
...
void GroupLayout::AddParmPicker( ParmPicker & parm_picker )
{
    ...
    //==== Container Button ====//
    Fl_Button* button = new Fl_Button( m_X, m_Y, m_ChoiceButtonWidth, m_StdHeight, "参数容器" );
    button->box( FL_THIN_UP_BOX );
    button->labelfont( FL_HELVETICA_BOLD );
    button->labelsize( 12 );
    button->labelcolor( FL_BLACK );
    ...
    //==== Group Button ====//
    button = new Fl_Button( m_X, m_Y, m_ChoiceButtonWidth, m_StdHeight, "组" );
    button->box( FL_THIN_UP_BOX );
    button->labelfont( FL_HELVETICA_BOLD );
    button->labelsize( 12 );
    button->labelcolor( FL_BLACK );
    ...
    //==== Parm Button ====//
    button = new Fl_Button( m_X, m_Y, m_ChoiceButtonWidth, m_StdHeight, "参数" );
    button->box( FL_THIN_UP_BOX );
    button->labelfont( FL_HELVETICA_BOLD );
    button->labelsize( 12 );
    button->labelcolor( FL_BLACK );
...
void GroupLayout::AddPCurveEditor( PCurveEditor& curve_editor )
{
    ...
    convbutton->copy_label( VSPTranslate( "Convert to:" ).c_str() );
    ...
    spbutton->copy_label( VSPTranslate( "Split" ).c_str() );
    ...
    splitpickbutton->copy_label( VSPTranslate( "Split Pick" ).c_str() );
    ...
    deletebutton->copy_label( VSPTranslate( "Del" ).c_str() );
    ...
    deletetoggle->copy_label( VSPTranslate( "Del Pick" ).c_str() );
