...
SelectFileScreen::SelectFileScreen( ScreenMgr* mgr ) : BasicScreen( mgr, 440, 345, "Open VSP File (*.vsp3)")
{
    ...
    m_FavsMenuButton = new Fl_Menu_Button(370, 2, 65, 20, "收藏夹");
...
void SelectFileScreen::LoadFavsMenu()
{
    ...
    m_FavDirVec.clear();
    m_FavsMenuButton->add( "添加到收藏夹" );
    m_FavsMenuButton->add( "清空收藏夹", 0, nullptr, ( void* )0, FL_MENU_DIVIDER );
    m_FavsMenuButton->add( "主目录" );
    m_FavsMenuButton->add( "VSP 目录", 0, nullptr, ( void* )0, FL_MENU_DIVIDER );
