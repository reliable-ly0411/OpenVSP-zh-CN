...
public:
    ...
    //Comp Geom
    string CompGeom( int set, int degenset, int halfFlag, int intSubsFlag = 1, bool hideset = true, bool suppressdisks = false, bool useMode = false, const string &modeID = string(), int n_ref = 0, const vector < string > & sub_vec = vector < string > (), const string & singleGeomID = string() );
    string CompGeomAndFlatten( int set, int halfFlag, int intSubsFlag = 1, int degenset = vsp::SET_NONE, bool hideset = true, bool suppressdisks = false, bool useMode = false, const string &modeID = string(), int n_ref = 0, const vector < string > & sub_vec = vector < string > (), const string & singleGeomID = string() );
